...
use Engaz\Lead\Traits\StatusCodeTrait;
...
//             // return $this->HttpValidationError($this->response, 'mobile is empty', 442);
//         }
//         $specialChars = ['*', '-', '\\', '\'', '"', '.', '=', '␉', '_', '/', '☆'];
...
//             // return $this->HttpValidationError($this->response, 'invalid mobile', 442);
//         }
//         return $number;
//     }
